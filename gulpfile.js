...
// Project related.
var project                 = 'wpadcenter-lite'; // Project Name.
var projectURL              = 'http://homeranjith.com/wordpress'; // Project URL. Could be something like localhost:8888.
var productURL              = './'; // Theme/Plugin URL. Leave it like it is, since our gulpfile.js lives in the root folder.

// Translation related.
var text_domain             = 'wpadcenter-lite'; // Your textdomain here.
var destFile                = 'wpadcenter-lite.pot'; // Name of the transalation file.
var packageName             = 'wpadcenter-lite'; // Package name.
var bugReport               = 'https://AhmadAwais.com/contact/'; // Where can users report bugs.
var lastTranslator          = 'Ranjith Nair <ranjith.nair@hbwsl.com>'; // Last translator Email ID.
var team                    = 'UserPro <ranjith.nair@hbwsl.com>'; // Team's Email ID.
var translatePath           = './languages' // Where to save the translation files.

// Style related.
var styleSRC                = './admin/css/*.css'; // Path to main .scss file.
var styleDestination        = './'; // Path to place the compiled CSS file.
// Defualt set to root folder.

// JS Vendor related.
var jsVendorSRC             = './admin/js/*.js'; // Path to JS vendor folder.
